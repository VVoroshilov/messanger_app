...
export default class App extends Component {
  ...
  let last_message = chat.multimedia_amount === 0 ? (chat.message_text.length > 45 ? (chat.message_text.substring(0, 45) + "...") : (chat.message_text)) : "Multimedia: " + chat.multimedia_amount;
